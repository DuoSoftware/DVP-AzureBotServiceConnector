# facetone
facetone azure botframework connector
...
- Navigate to `facetone` folder
- Select `facetone.bot` file
...
msbot clone services --name "facetone" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
